...
function drawScene() {
  ...
  matriceSol = math.multiply(matriceSol, yRotation(degres));

  let matriceCube = [100,150,0];
  degres = degres + 0.01;
  ...
  draw(inversedCameraMatrixWorld, getTourGeometry(), matriceTour, [0, 0, 0, 1]);
  draw(inversedCameraMatrixWorld, getSol(), matriceSol, [0, 0, 0, 1]);
  draw(inversedCameraMatrixWorld, getCubeGeometry(), matriceCube, [0, 0, 0, 1]);
